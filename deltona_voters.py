...
def page_1():
   ...
   # get the summaries and detailed records
    ...
    st.write('<style>table th.col_heading, th.row_heading {border: padding: 8px; background-color: #f2f2f2; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold;} </style>', unsafe_allow_html=True)
