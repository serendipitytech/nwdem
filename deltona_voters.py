...
def page_1():
   ...
   # get the summaries and detailed records
    ...
    st.write('<style>table th.col_heading {border: padding: 8px; background-color: #f2f2f2; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold;} th.row_heading {border: padding: 8px; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold;}</style>', unsafe_allow_html=True)
...
def page_2():
    ...
    def create_pie_chart(data, title, width=500, height=300):
        ...
        fig.update_layout(legend=dict(orientation="v", yanchor="middle", y=0.02, xanchor="left", x=0.001))  # Adjust legend position
        return fig
